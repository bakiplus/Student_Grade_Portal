...
AMHARIC_NAME_MAP = {
    ...
    # Batch 5 Students
    'ሲፓራ': 'sipara', 'ሲጶራ': 'sipara',
    'ያለምወርቅ': 'yalemwork', 'አለምወርቅ': 'yalemwork', 'ዓለምወርቅ': 'yalemwork',
    'ሰሎሜ': 'selome',
    'ቴዎድሮስ': 'tewodros', 'ተዎድሮስ': 'tewodros', 'ቴወድሮስ': 'tewodros',
    'ፍሬህይወት': 'forehiwot', 'ፍሬሕይወት': 'forehiwot', 'ፎረህይወት': 'forehiwot', 'ፍሬ ሕይወት': 'forehiwot',
    'አስቴር': 'aster', 'አስተር': 'aster',
    'ህይወት': 'hiwot', 'ሕይወት': 'hiwot', 'ሂወት': 'hiwot',
    'አበባ': 'abeba',
    'ራሄል': 'rahel', 'ራሔል': 'rahel', 'ራሀል': 'rahel',
    'ሙሉነሽ': 'mulunesh', 'ሙሉነሺ': 'mulunesh',
    'ቅዱሳን': 'kidusan',
    'ሄለን': 'helen', 'ሔለን': 'helen', 'ሀለን': 'helen',
    'ሙሴ': 'moses', 'ሞሰስ': 'moses',
    'ዳግማዊት': 'dagmawit', 'ዳጊ': 'dagmawit',
    'ኤደን': 'eden', 'እደን': 'eden',
    'አብይ': 'abiy', 'ዐቢይ': 'abiy', 'አቢይ': 'abiy',
    'ኤፍሬም': 'efrem', 'እፍሬም': 'efrem',
    'ሳሙኤል': 'samuel', 'ሳሚ': 'samuel',
    'ጌታቸው': 'getachew', 'ገታቸው': 'getachew',

    # Additional standard names
    'ቤተልሔም': ('betlehem', 'betelhem'), 'ቤቴልሔም': ('betlehem', 'betelhem'), 'ቤተልሄም': ('betlehem', 'betelhem'),
